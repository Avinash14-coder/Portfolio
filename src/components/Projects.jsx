...
const projects = [
  {
    ...
    image: "/assets/claimcraft.png",
    demoLink: "https://claimcraft.vitthalhumbe.me/",
    repoLink: "https://github.com/Avinash14-coder/ciphercrew-claimcraft.git",
    status: "Active"
  },
...

  {
    ...
    image: "/assets/Eventra.png",
    demoLink: "https://event-planner-delta-one.vercel.app/",
  ...
  },
  {
    ...
    demoLink: "https://phishguard-bice-ten.vercel.app/",
  ...
  },
  {
    ...
    demoLink: "https://heart-guard-analytics.vercel.app/",
    repoLink: "https://github.com/Avinash14-coder/HeartGuard-Analytics.git",
    status: "Active"
  }
];
            ...
            <div key={index} className="bg-[#1a0b2e] rounded-2xl overflow-hidden border border-white/5 hover:border-purple-500/50 transition group flex flex-col shadow-lg">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="flex justify-between items-start mb-3">
                  ...
                  <span className={`text-[10px] uppercase tracking-wider font-bold px-2.5 py-1 rounded-full border ${project.status === 'Active' ? 'bg-green-500/20 text-green-400 border-green-500/30' :
